...
- [ ] What problem does the context API help solve?
  *It solves the issue of writing unneccessary code to do the same thing as everything else.
- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
    *The store acts as the default database in which the app gets its data from. This helps you because you don't have to prop drill.
    *Actions allow you to change state by being an object that describes what happened
    *Reducers are pure functions that specify how the state tree was transformed by actions
- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?
  *Application state provides state for the entire application and component state is for the individual component. Component state is good for small applications.
- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
  * They allow us to call action creators that return a function instead of an object.
- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
  * Context API is my favorite. It cuts out some much unneccessary code.
